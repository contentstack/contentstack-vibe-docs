...
| Configure regions/endpoints | [regions.md](references/concepts/regions.md) | 349 |
...
| Build with Nuxt | [nuxt.md](references/frameworks/nuxt.md) | 406 |
...
| See real-world code patterns | [practical-examples.md](references/examples/practical-examples.md) | 408 |
